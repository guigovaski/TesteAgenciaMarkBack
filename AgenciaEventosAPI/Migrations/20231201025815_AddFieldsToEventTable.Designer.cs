...
namespace AgenciaEventosAPI.Migrations
{
    ...
    [Migration("20231201025815_AddFieldsToEventTable")]
    partial class AddFieldsToEventTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AgenciaEventosAPI.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EventId = 1,
                            Date = new DateTime(2023, 12, 1, 23, 58, 15, 843, DateTimeKind.Local).AddTicks(2253),
                        ...
                        {
                            EventId = 2,
                            Date = new DateTime(2023, 12, 2, 23, 58, 15, 843, DateTimeKind.Local).AddTicks(2269),
                        ...
                        {
                            EventId = 3,
                            Date = new DateTime(2023, 12, 3, 23, 58, 15, 843, DateTimeKind.Local).AddTicks(2270),
